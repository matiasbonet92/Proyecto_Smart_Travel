...
<html >
  ...
  <body style="background-image: url('../media/back.jpg');background-repeat: no-repeat;background-attachment: fixed;background-size: cover;">
    ...
    <div class="body">
      <div class="row w-100 m-0 p-1"></div>
        <div class="row w-100 m-0 p-1">

          <div class="col-6">
            <div class="p-3 border bg-light"><h3>Preguntas Frecuentes</h3></div>
          ...
          <div class="col-6">
            <div class="p-3 border bg-light"> <h3>Acerca de Nosotros</h3> </div>
            <div class="p-3 border bg-light">
            ...
            <div class="col-6">
              <div class="p-3 border bg-light"><h3>Centro de Ayuda Aerolíneas</h3></div>
                  ...
                  <?php foreach ($this->empresas as $empresa) { ?>
                    <tbody>
                      <tr class="table-primary">
                        ...
                        <td>
                        <a href="https://maps.google.com/?q=<?= $empresa['direccion'] ?>"><?= $empresa['direccion'] ?></a>
                        </td>
                        <td>
