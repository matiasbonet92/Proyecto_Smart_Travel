  				...
  				<div class="container m-0 mt-3 p-3 border border-2 border-dark rounded">
  							...
  							<div class="form-group w-100 mt-1">
								...
								<div class="form-group w-100 mt-1">
									<div class="w-100">
										...
										<input type="text" class="form-control" name="descripcion_vuelo" value="<?= $datos['descripcion_vuelo'] ?>">
									</div>
								</div>
						...
						<div class="row w-100 m-0 p-0">
							<button type="button" name="button" class="btn btn-danger">
							    <a class="navbar-brand" style="color: white; font-size: 16px;" href="../controllers/administrador.php">Volver a Vuelos</a>
							</button>
						</div>
          <?php } ?>
					</div>
